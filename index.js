...
const slashCommands = [
    ...
    // /admin command (FIXED DESCRIPTIONS HERE)
    new SlashCommandBuilder()
        .setName('admin')
        .setDescription('Admin commands')
        .addSubcommand(sub => 
            sub.setName('add')
               .setDescription('Add link')
               .addStringOption(o => 
                   o.setName('category')
                    .setDescription('Select the category') // <--- FIXED: Added Description
                    .setRequired(true)
                    .addChoices(...VALID_CATEGORIES.map(c => ({name: c, value: c})))
               )
               .addStringOption(o => 
                   o.setName('url')
                    .setDescription('The image URL') // <--- FIXED: Added Description
                    .setRequired(true)
               )
        )
        .addSubcommand(sub => 
            sub.setName('bulkadd')
               .setDescription('Upload .txt file')
               .addStringOption(o => 
                   o.setName('category')
                    .setDescription('Select the category') // <--- FIXED: Added Description
                    .setRequired(true)
               ...
               .addAttachmentOption(o => 
                   o.setName('file')
                    .setDescription('The .txt file') // <--- FIXED: Added Description
                    .setRequired(true)
               )
        )
        .addSubcommand(sub => 
            sub.setName('reset')
               ...
               .addStringOption(o => 
                   o.setName('category')
                    .setDescription('Select category to wipe') // <--- FIXED: Added Description
                    .setRequired(true)
                    .addChoices(...VALID_CATEGORIES.map(c => ({name: c, value: c})))
               )
        )
