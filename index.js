...
// --- ANTI-CRASH SYSTEM (Prevents bot from dying) ---
...
function loadData() {
    try {
        ...
        if (fs.existsSync(filePath)) {
            ...
            catch (e) { console.log("Rebuilding corrupted database..."); data = {}; }
        }
...
if (!process.env.TOKEN) {
    console.error("CRITICAL ERROR: TOKEN is missing in .env file");
    // Keep process alive to show logs, but bot won't work
    setInterval(() => {}, 1000); 
}
